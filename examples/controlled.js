...
function (_React$Component) {
  ...
  function Test() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDestroy", function () {
      _this.setState({
        destroy: 1
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onBlur", function (v) {
  ...
  _createClass(Test, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "controlled Select"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        style: {
          width: 300
        }
