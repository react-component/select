...
function (_React$Component) {
  ...
  function Test(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateLabel", function () {
      _this.setState({
        label: "newlabel ".concat(_this.count++)
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateOptions", function (value) {
  ...
  _createClass(Test, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "label: ", label, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rc_select__WEBPACK_IMPORTED_MODULE_1___default.a, {
        defaultValue: "lucy",
        ...
        value: "lucy"
      }, label), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rc_select__WEBPACK_IMPORTED_MODULE_1__["Option"], {
        value: "lucy2"
      }, "lucy2")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        onClick: this.updateLabel
      }, "update option label")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rc_select__WEBPACK_IMPORTED_MODULE_1___default.a, {
        combobox: true,
        optionLabelProp: "children",
