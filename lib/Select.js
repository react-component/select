...
var Select = React.createClass({
  ...
  handleSearch: function (e) {
    ...
    // change children
    this.props.children = this.filterList.length ? this.filterList :
  ...
  setMenuProps: function (multiple, props, selection) {
    ...
    menuProps.activeKey = selectedKeys[selectedKeys.length - 1];
  ...
  renderSelection: function (multiple, input) {
    ...
    if (multiple) {
      ...
      ctrlNode = <span className="select-selection__rendered">{sel}</span>;
    }
